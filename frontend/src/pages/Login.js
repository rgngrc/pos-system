    ...
    setTimeout(() => {
      ...
      if (!foundUser) {
        ...
        setAuditLog(prev => [...prev, {
          id: Date.now(), type: 'Login', status: 'Failed',
          actor: username, actorName: username,
      ...
      if (!recentLogin) {
        setAuditLog(prev => [...prev, {
          id: Date.now(), type: 'Login', status: 'Completed',
          actor: foundUser.username, actorName: foundUser.name,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(77,159,255,0.03) 0%, transparent 70%)',
          borderRadius: '50%',
        }} />
        {/* Grid pattern */}
        ...
        <div style={{
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 6, letterSpacing: '0.05em' }}>
                USERNAME
              </label>
            ...
            >
              {loading ? (
                <>
                  <span className="pos-spinner" style={{ width: 16, height: 16 }} />
                  Signing in...
                </>
              ) : (
                <>
